...
const Hero = () => {
  ...
  const stats = useMemo(() => [
    { label: t('hero.stats.fleets'), value: '500+' },
    { label: t('hero.stats.impressions'), value: '2.5M+' },
    { label: t('hero.stats.cities'), value: '25+' },
      ...
      <div className="relative z-10 container-custom text-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <br />
            <span className="text-white">{t('hero.title.part3')}</span>
          </motion.h1>
