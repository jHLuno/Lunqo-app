      ...
      <div className="container-custom">
        ...
        >
          {benefits.map((benefit, index) => (
            ...
            >
              {/* Neon Accent Line */}
              <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-primary-blue via-primary-lime to-primary-orange opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
              
              {/* Icon */}
              <motion.div
                className="w-16 h-16 rounded-2xl bg-primary-blue/10 border border-primary-blue/20 flex items-center justify-center mb-6 group-hover:bg-primary-blue/20 group-hover:border-primary-blue/40 transition-all duration-200"
                whileHover={{ 
                  scale: 1.05,
                  transition: { duration: 0.2 }
                }}
              ...
              <div className="relative z-10">
                ...
                <p className="text-dark-300 leading-relaxed mb-4 group-hover:text-dark-200 transition-colors duration-200">
                  {benefit.description}
                </p>
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-primary-blue/5 via-primary-lime/5 to-primary-orange/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </motion.div>
          ))}
        </motion.div>
