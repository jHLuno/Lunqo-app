  ...
  return (
    <section className="relative overflow-hidden">
      {/* Gradient Background - Subtle Blue to Lime to Orange to Black */}
              <div className="absolute inset-0 bg-gradient-to-b from-[#12161d]/20 via-primary-lime/10 to-primary-orange/30"></div>
      <div className="absolute inset-0 bg-gradient-to-b from-transparent from-20% to-black"></div>
